...
namespace 
{
    ...
    const std::array<GLuint, 36> kCubeIndices = 
    {{
        0,  2,  1,  0,  3,  2,
        4,  6,  5,  4,  7,  6,
        8, 10,  9,  8, 11, 10,
...
void PrimitiveMeshFactory::GenerateSphereData(std::vector<Vertex>& vertices, std::vector<GLuint>& indices, 
                                             int segments, int rings) 
{
    vertices.clear();
    indices.clear();
...
MeshAsset* PrimitiveMeshFactory::CreatePlane(AssetManager* assetManager, const std::string& name,
...
void PrimitiveMeshFactory::GeneratePlaneData(std::vector<Vertex>& vertices, std::vector<GLuint>& indices,
                                            float width, float height) 
{
...
MeshAsset* PrimitiveMeshFactory::CreateCylinder(AssetManager* assetManager, const std::string& name,
...
MeshAsset* PrimitiveMeshFactory::CreateCone(AssetManager* assetManager, const std::string& name,
                                           float radius, float height, int segments) 
{
    if (assetManager->HasMesh(name)) 
    {
...
void PrimitiveMeshFactory::GenerateConeData(std::vector<Vertex>& vertices, std::vector<GLuint>& indices,
                                           float radius, float height, int segments) 
{
    vertices.clear();
    indices.clear();
